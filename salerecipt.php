...
<?php
    ...
    $sql = "SELECT proddetails.pName,saleitem.sInvQty,saleitem.itemMrp
          FROM saleitem
          INNER JOIN proddetails ON saleitem.prodId = proddetails.prodId
          WHERE sInvNo = '".$invno."'";
...
<table>
    <table id="customer"><tr><th>Product Id</th><th>Quantity</th><th>MRP</th></tr>
      ...
      <tr>
        ...
        <td><?php echo $row["sInvQty"]; ?></td>
        <td><?php echo $row["itemMrp"]; ?></td>
      </tr>
    <?php } ?>
</table>
<?php } ?>
